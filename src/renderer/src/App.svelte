...
<div class="footer">
    Made by <a href="mailto:jan.reges@siteone.cz?subject=SiteOne Crawler feedback" class="text-info">Ján Regeš</a> @ 2023-2025 | {'v' + VERSION} | <a on:click={openCrawlerHomepage} target="_blank" class="text-info cursor-pointer">crawler.siteone.io</a>
</div>
